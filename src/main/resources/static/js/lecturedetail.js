let detailInit = {
    ...
    init: function () {
        ...
        $('.subPhoto > img').on('click', () => {
            this.changeImage();
        });
        $('#prevCalendar').bind('click', () => {
            this.save();
        });
        $('#prevCalendar').bind('click', () => {
            this.prevCalendar();
        });
        $('#nextCalendar').bind('click', () => {
            this.nextCalendar();
        });
    },
                ...
                if (result.length > 0) {
                    ...
                    result.forEach((element) => {
                        ...
                        $reserveSession.click(function () {
                            makePaymentUrl(element.lectureSessionId);
                        });
                        ...
                        // 시간대 요소 생성 및 텍스트 설정
                        const $duration = $('<div class="reserveSessionDuration">').text(calculateTimeWithOffset(unixTimestamp, minutesOffset));
